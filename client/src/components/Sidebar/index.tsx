...
export const Sidebar = () => {
  ...
  return (
    <div
      className={`fixed z-40 flex h-full ${isSidebarCollapsed ? "hidden w-0" : "w-64"} flex-col justify-between overflow-y-auto bg-white shadow-xl transition-all duration-300 dark:bg-black overflow-x-hidden`}
    >
